-- Add pacote_quarto_id to reserva_vagas table
ALTER TABLE reserva_vagas
ADD COLUMN IF NOT EXISTS pacote_quarto_id UUID REFERENCES pacote_quartos(id);

-- Update the RPC function to handle pacote_quarto_id
...
BEGIN
    ...
    LOOP
        INSERT INTO public.reserva_vagas (
            ...
            (vaga_item ->> 'preco')::numeric,
            (vaga_item ->> 'pacote_quarto_id')::uuid -- Extract package ID (can be null)
        );
    END LOOP;
